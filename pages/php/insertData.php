...
$targetPath = "../../assets/userImages/".$_FILES['userImage']['name'];
if(move_uploaded_file($sourcePath,$targetPath)) {

 rename($targetPath, '../../assets/userImages/'.$contact1.$adder.'.jpg');

$d='../../assets/userImages/'.$contact1.$adder.'.jpg';
//echo $d;
...
if($result)
{
    $result1=mysqli_query($con,"insert into users(name,referencedId,paymentStatus,hierarchy,image) values('$name','$nomineeID','0','$hierarchy','$d')") or die (mysqli_query($con));
