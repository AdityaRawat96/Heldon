...
<body style="background-image: linear-gradient(#303840, #303850) !important;">
    ...
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index-2.html">
          <span><img src="../../assets/images/logo_alt.png" alt="" style="height:70px;width:70px;">&nbsp; HELDON PANEL</span>
        </a>
      </div>
    </div>
  </nav>
      ...
      <footer class="footer">
        <div class="container">
          ...
          <p class="copyright pull-right">
            ...
            <a href="http://wtsolutions.cc">WT</a> Heldon Dashboard
          </p>
        </div>
      </footer>
    </div>
