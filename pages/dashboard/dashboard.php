    ...
    <div class="main-panel">
      ...
      <div class="content">
        <div class="container-fluid">
          ...
          <section class="management-hierarchy" style="position:relative; min-height:750px;padding:10px;">
            <center><h3 style="color:white;"><strong>Management Hierarchy</strong></h3></center><br>
