<?php
   ...
   $result= mysqli_query($con,"select * from userinfo where email='$uname'")
...
$mail->Subject = 'Heldon Password Change Request';
$mail->Body    = '
<html>
<body>
<br>
	<h4>Dear User,<br><br>Dear,<span style="text-transform:capitalize;"> <B></B></span><strong>OTP</strong> for your password change request is <br><br><br>
